...
description: Complete reference for Odoo 16 actions (ir.actions.*). Covers window actions, URL actions, server actions, report actions, client actions, scheduled actions, and action bindings.
globs: "**/*.{py,xml}"
topics:
...
Complete reference for Odoo 16 actions: window, URL, server, report, client, and scheduled actions with bindings.
