---
name: odoo-16-mixins
description: Complete reference for Odoo 16 mixins and useful classes. Covers mail.thread (messaging, chatter, field tracking), mail.alias.mixin, mail.activity.mixin, utm.mixin, website.published.mixin, website.seo.metadata, and rating.mixin.
globs: "**/models/**/*.py"
topics:
...
Complete reference for Odoo 16 mixins: messaging, email, activities, tracking, website features, and ratings.
