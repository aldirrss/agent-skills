...
description: Complete reference for Odoo 16 security covering access rights (ACL), record rules, field-level access, security pitfalls, SQL injection prevention, XSS prevention, and safe coding practices.
globs: "**/*.{py,xml,csv}"
topics:
...
Complete reference for Odoo 16 security: access rights, record rules, field access, and preventing security pitfalls.
