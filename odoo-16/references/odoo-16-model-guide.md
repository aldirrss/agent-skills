...
### search_fetch() - Search and Fetch Fields (Odoo 16)
...
## _read_group Internal Methods (Odoo 16)
...
### _read_group() - Core Aggregation Method (Odoo 16)
...
### group_expand Parameter (Odoo 16)
...
**Odoo 16**: `create()` expects a list of dicts and returns a recordset.
...
### Relational Domain Operators (Odoo 16)
...
### Date Field Granularities (Odoo 16)
...
### Environment Check Methods (Odoo 16)
...
### Environment Properties (Odoo 16)
...
### Flush before raw query (Odoo 16)

```python
# Flush ORM cache sebelum raw SQL agar data konsisten
self.env.flush_all()
...
## Recordset Utility Methods (Odoo 16)
...
### filtered_domain() - Filter by Domain (Odoo 16)
...
## Advanced Model Attributes (Odoo 16)
