...
description: "Complete reference for Odoo 16 API decorators (@api.model, @api.depends, @api.constrains, @api.onchange, @api.ondelete, @api.returns) and their proper usage patterns."
globs: "**/models/**/*.py"
topics:
  ...
  - api.ondelete (delete validation, Odoo 16)
...
Complete reference for Odoo 16 API decorators and their proper usage.
...
**Note**: If you override `create()` without `@api.model_create_multi`, Odoo 16 will show a deprecation warning.
...
| `@api.ondelete` | Delete validation (Odoo 16) | **18+** |
...
## Decorator Decision Tree (Updated for Odoo 16)
