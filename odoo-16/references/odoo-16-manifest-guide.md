...
description: Complete reference for Odoo 16 module manifest (__manifest__.py) covering all fields, dependencies, assets, external dependencies, hooks, auto_install, and module structure.
...
Complete reference for Odoo 16 `__manifest__.py`: all fields, dependencies, assets, hooks, and configuration.
