...
description: Complete guide for Odoo 16 module development covering manifest structure, security, reports, wizards, data files, hooks, and exception handling.
globs: "**/*.{py,xml,csv}"
topics:
...
Complete guide for Odoo 16 module development: manifest structure, reports, security, wizards, and advanced patterns.
...
| `version` | str | Yes | Version (e.g., `16.0.1.0.0`) |
