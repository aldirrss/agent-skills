---
name: odoo-16-view
description: Complete reference for Odoo 16 XML views, actions, menus, and QWeb templates. Covers list, form, search, kanban, graph, pivot, calendar views and Odoo 16 changes.
globs: "**/views/**/*.xml"
topics:
...
when_to_use:
  ...
  - Migrating from Odoo 16 to 17/18
---

# Odoo 16 View Guide

Complete reference for Odoo 16 XML views, actions, menus, and QWeb templates.
...
<form string="My Record" create="true" edit="true" delete="true">
    ...
    <widget name="web_ribbon" title="Archived"
            bg_color="text-bg-danger" attrs="{'invisible': [('active', '=', True)]}"/>
...
### Dynamic Attributes (Odoo 16 - Direct Attributes)

**IMPORTANT**: In Odoo 16, the `attrs` attribute is **DEPRECATED**. Use direct attributes instead.

#### ❌ BAD: Using `attrs` (Old Odoo 13-17 syntax)

```xml
<!-- Old syntax - DEPRECATED in Odoo 16 -->
