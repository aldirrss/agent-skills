...
### Date/Datetime Helper Methods (Odoo 16)
...
### Image - Image Field with Resize (Odoo 16)
...
### Many2oneReference - Dynamic Typed Reference (Odoo 16)
...
# One2many with computed domain (Odoo 16)
...
## Odoo 16 Field Parameters

### aggregator (Odoo 16)

**Replaces**: `group_operator` (deprecated since Odoo 16)

```python
# Odoo 16+ - use aggregator
amount = fields.Float(
    string='Amount',
    group_operator='sum',  # NEW in Odoo 16
)
...
**Deprecated in Odoo 16**: Use `aggregator` instead.
