...
description: Complete reference for Odoo 16 QWeb reports covering PDF/HTML reports, report templates, paper formats, custom reports, custom fonts, translatable templates, barcodes, and report actions.
globs: "**/*.{py,xml}"
topics:
...
Complete reference for Odoo 16 QWeb reports: PDF/HTML reports, templates, paper formats, and custom reports.
